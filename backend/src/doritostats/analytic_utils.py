...
def weekly_stats_analysis(df: pd.DataFrame, year: int, week: int) -> None:
    ...
    league_positive_stats_to_check = [
        ...
        {"stat": "special_teams_pts", "units": "pts", "high_first": True, "n": 5},
    ...
    league_negative_stats_to_check = [
        ...
        {"stat": "special_teams_pts", "units": "pts", "high_first": False, "n": 5},
    ...
    franchise_positive_stats_to_check = [
        ...
        {"stat": "special_teams_pts", "units": "pts", "high_first": True, "n": 1},
    ...
    franchise_negative_stats_to_check = [
        ...
        {"stat": "special_teams_pts", "units": "pts", "high_first": False, "n": 1},
