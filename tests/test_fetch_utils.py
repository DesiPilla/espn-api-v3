...
league_2018 = League(league_id=league_id, year=2018,
                     swid=swid, espn_s2=espn_s2)
league_2021 = League(league_id=league_id, year=2021,
                     swid=swid, espn_s2=espn_s2)
league_2022 = League(league_id=league_id, year=2022,
                     swid=swid, espn_s2=espn_s2)
...
@pytest.mark.parametrize("league, endpoint",
                         [(league_2018, "https://fantasy.espn.com/apis/v3/games/ffl/leagueHistory/1086064?seasonId=2018&"),
                          (league_2021, "https://fantasy.espn.com/apis/v3/games/ffl/leagueHistory/1086064?seasonId=2021&"),
...
@pytest.mark.parametrize("league, matchup, week, result",
                         [
                             ...
                             (league_2021, league_2021.box_scores(
                                 1)[0], 1, False),  # Regular season
                             (league_2021, league_2021.box_scores(
                                 15)[0], 15, False),  # Playoff Bye
                             (league_2021, league_2021.box_scores(
                                 15)[1], 15, True),  # Playoff game
                             (league_2021, league_2021.box_scores(15)
