        ...
        <div style={containerStyle}>
            ...
            >
                ...
                {league?.roster_config &&
                    Object.keys(league.roster_config).length > 0 && (
                        <div
                            style={{
                                padding: "12px 16px",
                                backgroundColor: "#ffffff",
            ...
            <div style={{ borderTop: "1px solid #f1f5f9" }}>
                {(() => {
                    ...
                    // Add empty slots
                    const emptySlots =
                        (league?.num_teams || 0) - members.length;
            ...
            >
                ...
                >
                    <div style={{ fontSize: "14px", color: "#4b5563" }}>
                        <strong>{members.length}</strong> of{" "}
                        <strong>{league?.num_teams}</strong> teams filled
                    </div>
            ...
            {/* Delete League Section - Only visible to admins */}
            {isAdmin && (
                <div
                    style={{
                    ...
                    >
                        <div>
                            ...
                            <div style={{ fontSize: "12px", color: "#7f1d1d" }}>
                                Once you delete a league, there is no going
