            ...
            overflow: 'hidden'
              ...
              {leagues.length === 0 ? (
                  <div style={{ padding: '48px 24px', textAlign: 'center', color: '#9ca3af' }}>
                      <p style={{ fontSize: '18px', marginBottom: '16px', fontWeight: '500' }}>No leagues yet!</p>
                  ...
                  <>
                      ...
                      <div style={{ 
                        display: 'grid', 
                        gridTemplateColumns: '5% 25% 15% 20% 15% 10% 10%', 
                        ...
                        borderBottom: '1px solid #e2e8f0' 
                          ...
                          <div style={{ padding: '12px 8px', fontSize: '12px', fontWeight: '500', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em' }}>LEAGUE NAME</div>
                          <div style={{ padding: '12px 8px', fontSize: '12px', fontWeight: '500', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em', textAlign: 'center' }}>TEAMS</div>
                          <div style={{ padding: '12px 8px', fontSize: '12px', fontWeight: '500', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em' }}>YOUR TEAM</div>
                          <div style={{ padding: '12px 8px', fontSize: '12px', fontWeight: '500', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em', textAlign: 'center' }}>POSITIONS</div>
                          ...
                          <div style={{ padding: '12px 8px', fontSize: '12px', fontWeight: '500', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em', textAlign: 'center' }}>CREATED</div>
                      </div>
                                  ...
                                  <div style={{ textAlign: 'center', padding: '0 8px' }}>
                                      <span style={{ fontSize: '12px', color: '#6b7280' }}>
                                          {Array.isArray(league.positions_included) 
                                              ? league.positions_included.length
                                              : 0} pos
                                      </span>
                                  </div>
